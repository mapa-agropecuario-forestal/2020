#
# RECLASIFICACIÓN DE CAPAS RASTER SIN HUMEDALES
#
...
# Archivo raster de capa de uso agropecuario forestal inicial sin humedales
ARCHIVO_RASTER_USO_AGROPECUARIO_FORESTAL <-
  here(
    "salidas", 
    "mapa-agropecuario-forestal-2020-inicial-v3.tif"
  )
...
ARCHIVO_RASTER_USO_AGROPECUARIO_FORESTAL_RECLASIFICADO <-
  here(
    "salidas", 
    "mapa-agropecuario-forestal-2020-inicial-reclasificado-v3.tif"
  )
