#
# COMBINACIÓN DE CAPAS RASTER SIN HUMEDALES
#
...
ARCHIVO_RASTER_USO_AGROPECUARIO_FORESTAL <-
  here("salidas", "mapa-agropecuario-forestal-2020-inicial-v3.tif")
...
cat("21/23 Procesando datos del Registro Nacional de Humedales (RNH) (se omite) ...\n")
