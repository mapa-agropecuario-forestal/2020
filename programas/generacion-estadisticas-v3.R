#
# GENERACIÓN DE ESTADÍSTICAS SIN HUMEDALES
#
...
ARCHIVO_RASTER_USO_AGROPECUARIO_FORESTAL_RECLASIFICADO <-
  here("salidas", "mapa-agropecuario-forestal-2020-v3.tif")

# Archivo CSV con estadísticas
ARCHIVO_CSV_ESTADISTICAS <-
  here("salidas", "estadisticas-v3.csv")


# PROCESAMIENTO

# Lectura del archivo raster de capa de uso agropecuario forestal sin humedales
